"""0006 промежуточная миграция

Revision ID: e92fd7709cd8
Revises: f44e5501473a
Create Date: 2026-03-25 11:13:37.289825
...
revision: str = 'e92fd7709cd8'
down_revision: Union[str, Sequence[str], None] = 'f44e5501473a'
...
def upgrade() -> None:
    ...
    op.drop_column('applicant_skills', 'level')
...
def downgrade() -> None:
    ...
    op.add_column('applicant_skills', sa.Column('level', sa.VARCHAR(length=50), autoincrement=False, nullable=False))
