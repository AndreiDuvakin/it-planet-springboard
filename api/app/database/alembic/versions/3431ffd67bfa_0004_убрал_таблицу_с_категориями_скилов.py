"""0004 убрал таблицу с категориями скилов

Revision ID: 3431ffd67bfa
Revises: 720b875eee30
Create Date: 2026-03-24 10:50:51.617693
...
revision: str = '3431ffd67bfa'
down_revision: Union[str, Sequence[str], None] = '720b875eee30'
...
def upgrade() -> None:
    ...
    op.drop_constraint(op.f('applicant_profiles_university_id_fkey'), 'applicant_profiles', type_='foreignkey')
    op.create_foreign_key(None, 'applicant_profiles', 'users', ['user_id'], ['id'], source_schema='public', referent_schema='public')
    op.create_foreign_key(None, 'applicant_profiles', 'universities', ['university_id'], ['id'], source_schema='public', referent_schema='public')
    ...
    op.drop_constraint(op.f('applicant_skill_tags_category_id_fkey'), 'applicant_skill_tags', type_='foreignkey')
    op.drop_table('applicant_skill_tag_categories')
    op.drop_column('applicant_skill_tags', 'category_id')
...
def downgrade() -> None:
    ...
    op.add_column('applicant_skill_tags', sa.Column('category_id', sa.INTEGER(), autoincrement=False, nullable=False))
    op.create_foreign_key(op.f('applicant_skill_tags_category_id_fkey'), 'applicant_skill_tags', 'applicant_skill_tag_categories', ['category_id'], ['id'])
    ...
    op.drop_constraint(None, 'applicant_profiles', schema='public', type_='foreignkey')
    op.create_foreign_key(op.f('applicant_profiles_university_id_fkey'), 'applicant_profiles', 'universities', ['university_id'], ['id'])
    ...
    sa.PrimaryKeyConstraint('id', name=op.f('applicant_skill_tag_categories_pkey'))
    )
    # ### end Alembic commands ###
