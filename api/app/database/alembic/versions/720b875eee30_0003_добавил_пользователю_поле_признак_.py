"""0003 добавил пользователю поле признак админа

Revision ID: 720b875eee30
Revises: 37e4d7c811c7
Create Date: 2026-03-21 10:43:28.981762
...
revision: str = '720b875eee30'
down_revision: Union[str, Sequence[str], None] = '37e4d7c811c7'
...
def upgrade() -> None:
    ...
    op.create_foreign_key(None, 'applicant_skill_tags', 'applicant_skill_tag_categories', ['category_id'], ['id'], source_schema='public', referent_schema='public')
...
def downgrade() -> None:
    ...
    op.drop_constraint(None, 'applicant_skill_tags', schema='public', type_='foreignkey')
