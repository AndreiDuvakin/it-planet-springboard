                ...
                <Row gutter={[12, 12]} align="middle">
                    <Col xs={24} md={14}>
                        <Space orientation="vertical" size={4}>
                            ...
                            <Text type="secondary">
                                Вакансии, стажировки, менторские программы и карьерные мероприятия
                            </Text>
                        </Space>
                    </Col>
                    <Col xs={24} md={10}>
                            ...
                            items={[
                                {
                                    ...
                                    children: filtered.length === 0
                                        ? <Empty description="Нет результатов по выбранным фильтрам"
                                                 style={{padding: 48}}/>
                                        : (
                                                ...
                                                >
                                                    {filtered.map((opp) => {
                                                        ...
                                                        return (
                                                            <div
                                                                key={opp.id}
                                                                onClick={() => onSelectMapItem(opp.id)}
                                                                style={{
                                                                    padding: '10px 12px',
                                                                    marginBottom: 6,
                                                                    borderRadius: 10,
                                                        ...
                                                        <List.Item
                                                            ...
                                                            actions={[
                                                                <Button
                                                                    ...
                                                                    size="middle"
                                                                    border="0"
                                                                    onClick={() => onToggleFavorite(opp.id)}
                                                                >
                                                                    {favoriteIds.includes(opp.id)
                                                                        ? <HeartFilled style={{color: '#e53935'}}/>
                                                                        : <HeartOutlined/>
                                                                    }
                                                                </Button>,
                                                            ...
                                                            <List.Item.Meta
                                                                title={
                                                                    <Flex align="center" gap={8} wrap="wrap">
                                                                        <Text strong
                                                                              style={{fontSize: 14}}>{opp.title}</Text>
                                                                        <Tag
                                                                            color={TYPE_COLORS[opp.type] || 'default'}
                                                                            style={{margin: 0}}
                                                                        >
                                                                            {TYPE_LABEL[opp.type] || opp.type}
                                                                        </Tag>
